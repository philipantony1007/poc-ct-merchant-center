...
import JobLogs from './components/cron-job-logs/Joblogs';
import CustomerGroup from './components/customer-segments/CustomerGroups';
...
const ApplicationRoutes = (_props: ApplicationRoutesProps) => {
  ...
  return (
    <Spacings.Inset scale="l">
      <Switch>
        <Route path={`${match.path}/customer-segments`}>
          <CustomerGroup linkToWelcome={match.url} />
        </Route>
        <Route>
          <JobLogs/>
        </Route>
